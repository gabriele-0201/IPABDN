...
% Smart Contracts are arbitrary code that can be uploaded on the chain and executed in the states transition function itself.

% In polkadot the code is stored as part of the state and it is then executed in sandboxed environment inside the use sandboxed environment
